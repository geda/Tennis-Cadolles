...
RankingService {
	...
	private void calculateRankingLooser(RankingList rankingList, Match match) throws EntityNotFoundException {
		...
		if (match.isDoubleMatch()) {
			...
			//Ajouter le match gagné du 2e joueur a son 1e opposant
			...
			//Ajouter le match gagné du 2e joueur a son 2e opposant 
	...
	private void calculateRankingWinner(RankingList rankingList, Match match) throws EntityNotFoundException {
		...
		// lire le ranking du winner et ajouter le match gagné au total des matches
		...
		// Ajouter le match gagné à son opposant
		...
		if (match.isDoubleMatch()) {
			//Ajouter le match gagné du premier joueur a son 2e opposant au 2e joueur
			...
			// Ajouter le match gangné au 2e joueur
